    ...
    def post(self, request, turn_id):
        ...
        try:
            feedback, evaluation = ratings_service.record_feedback_and_evaluate(
                turn_id=turn_id,
                user_id=user_id,
                rating_perceived_progress=data['rating_perceived_progress'],
                rating_clarity_understanding=data['rating_clarity_understanding'],
                rating_engagement_fit=data['rating_engagement_fit'],
        ...
        return Response(
            {
                ...
                'evaluation': {
                    ...
                    'q_progress': evaluation.q_progress if evaluation else None,
                    'q_confusion_reduction': evaluation.q_confusion_reduction if evaluation else None,
                    'q_clarity': evaluation.q_clarity if evaluation else None,
                    'q_engagement': evaluation.q_engagement if evaluation else None,
